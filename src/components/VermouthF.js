  ...
  <div className="vermouth-modal">
    ...
    <p>
      ...
      <a
        ...
        style={{ color: "#c6262" }}
      >
        <em>Wine Enthusiast magazine’s</em>
      </a>{" "}
    ...
    <div className="tasting-notes">
      ...
      <p>
        Deep reddish-brown hue yields to a rich nose of orange, cinnamon, pepper
        and vanilla - evolving as it opens. Leads with up-front spice to
        mid-palate dryness with the delicate finish of sweet vermouth on the
        back of the tongue. Round, complex flavor delivered in layers and
